...
$req="INSERT INTO etudiants.inscription(nom,prenom,naissance,sexe,residence,nationalite,mail,telelephone,telelephone2,specialite,niveau,diplome,etablissement,photo,nomurgent,mailurgent,telur) VALUES('$nom','$prenom','$birth','$sexe','$country','$nationalite','$mail','$tel1','$tel2','$diplome','$specialite','$niveau','$lastschool','$photo','$nameur','$mailur','$telur')";
try{
